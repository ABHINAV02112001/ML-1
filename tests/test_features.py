...
class TestFeatures(TestCase):
    ...
    def test_min_max_scaler(self):
        ...
        assert (
                    result == expected).all(), "Scaler transform does not return expected values. All Values should be between 0 and 1. Got: {}".format(
            result.reshape(1, -1))
    ...
    def test_min_max_scaler_single_value(self):
        ...
        assert (
                    result == expected).all(), "Scaler transform does not return expected values. Expect [[1.5 0. ]]. Got: {}".format(
            result)
    ...
    def test_standard_scaler_get_mean(self):
        ...
        scaler.fit(data)
        assert (scaler.mean == expected).all(), "scaler fit does not return expected mean {}. Got {}".format(expected,
                                                                                                             scaler.mean)
    ...
    def test_standard_scaler_transform(self):
        ...
        scaler.fit(data)
        result = scaler.transform(data)
        assert (result == expected).all(), "Scaler transform does not return expected values. Expect {}. Got: {}".format(
            expected.reshape(1, -1), result.reshape(1, -1))
    ...
    def test_standard_scaler_single_value(self):
        ...
        result = scaler.transform([[2., 2.]])
        assert (
                    result == expected).all(), "Scaler transform does not return expected values. Expect {}. Got: {}".format(
            expected.reshape(1, -1), result.reshape(1, -1))

    # TODO: Add a test of your own below this line

    def test_standard_scaler_custom_init(self):
        scaler = StandardScaler()
        assert isinstance(scaler, StandardScaler), "scaler is not a StandardScaler object"

    def test_standard_scaler_get_custom_mean(self):
        scaler = StandardScaler()
    ...
    def test_standard_scaler_custom_transform(self):
        scaler = StandardScaler()
    ...
    def test_standard_scaler_single_custom_value(self):
        data = [[1, 0], [1, 0], [0, 1], [0, 1]]
